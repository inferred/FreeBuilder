...
Download [freebuilder-1.0-rc10.jar][] and add it to the classpath (or
...
[freebuilder-1.0-rc10.jar]: http://repo1.maven.org/maven2/org/inferred/freebuilder/1.0-rc10/freebuilder-1.0-rc10.jar
...
```
compile 'org.inferred:freebuilder:1.0-rc10'
...
Download [freebuilder-1.0-rc10.jar][] and [guava-18.0.jar][] and add them to your
...
**Add JARs**, and select `freebuilder-1.0-rc10.jar`.
...
Download [freebuilder-1.0-rc10.jar][] and [guava-18.0][], add them to your project,
