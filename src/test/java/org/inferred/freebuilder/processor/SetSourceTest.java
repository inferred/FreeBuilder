...
public class SetSourceTest {
  ...
  public void test_guava_j8() {
    ...
    assertThat(source).isEqualTo(Joiner.on('\n').join(
        ...
        "   *",
        "   * This method mutates the set in-place. {@code mutator} is a void consumer,",
        "   * so any value returned from a lambda will be ignored. Take care not to",
        "   * call pure functions, like {@link Collection#stream()}.",
        "   *",
        "   * @return this {@code Builder} object",
