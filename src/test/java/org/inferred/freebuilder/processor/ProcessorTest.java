...
public class ProcessorTest {
  ...
  public void testBuilderSerializability_nonSerializableSubclass() {
    behaviorTester
        ...
        .with(
            testBuilder()
                .addLine("assertFalse(DataType.builder() instanceof %s);", Serializable.class)
                .build())
        .runTest();
  }
    ...
    behaviorTester
        ...
        .with(
            SourceBuilder.forTesting()
                ...
                .addLine("")
                .addLine(
                    "  public static class Builder extends DataType_Builder implements %s {}",
                    Serializable.class)
                .addLine("}"))
        .with(
            testBuilder()
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                ...
                .addLine("    .build();")
                .addLine(
                    "assertEquals(\"DataType{propertyA=11, propertyB=true}\", value.toString());")
                .build())
        .runTest();
  }
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                ...
                .addLine("    .addEqualityGroup(")
                .addLine(
                    "        new Person.Builder().setName(\"Bill\").setAge(10).buildPartial(),")
                .addLine(
                    "        new Person.Builder().setName(\"Bill\").setAge(10).buildPartial())")
                .addLine("    .addEqualityGroup(")
                .addLine(
                    "        new Person.Builder().setName(\"Bill\").setAge(18).buildPartial())")
                .addLine("    .addEqualityGroup(")
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                ...
                .addLine("    .build();")
                .addLine(
                    "assertThat(value.getNames()).containsExactly(\"fred\", \"jill\", \"bob\");")
                .build())
        .runTest();
  }
  ...
  private static SourceBuilder twoPropertyType() {
  ...
  private static SourceBuilder twoPropertyInterface() {
    return SourceBuilder.forTesting()
        .addLine("package com.example;")
        .addLine("@%s", FreeBuilder.class)
        .addLine("public interface DataType {")
  ...
  private static SourceBuilder stringPropertyType() {
    return SourceBuilder.forTesting()
        .addLine("package com.example;")
        .addLine("@%s", FreeBuilder.class)
        .addLine("public abstract class DataType {")
