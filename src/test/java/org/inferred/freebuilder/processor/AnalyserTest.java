...
public class AnalyserTest {
  ...
  public void emptyDataType() throws CannotGenerateCodeException {
    GeneratedType builder =
        analyser.analyse(model.newType("package com.example;", "public class DataType {", "}"));
  ...
  public void emptyInterface() throws CannotGenerateCodeException {
    GeneratedType builder =
        analyser.analyse(model.newType("package com.example;", "public interface DataType {", "}"));
        ...
        .isEqualTo(
            new GeneratedBuilder(
                new Datatype.Builder()
                    ...
                    .setPropertyEnum(generatedType.nestedType("Property").withParameters())
                    .setRebuildableType(
                        generatedType.nestedType("Rebuildable").withParameters(k, v))
  ...
  public void underriddenEquals() throws CannotGenerateCodeException {
    ...
    assertThat(builder.getDatatype().getStandardMethodUnderrides())
        .isEqualTo(ImmutableMap.of(StandardMethod.EQUALS, UnderrideLevel.OVERRIDEABLE));
    messager.verifyError(
  ...
  public void underriddenHashCode() throws CannotGenerateCodeException {
    ...
    assertThat(builder.getDatatype().getStandardMethodUnderrides())
        .isEqualTo(ImmutableMap.of(StandardMethod.HASH_CODE, UnderrideLevel.OVERRIDEABLE));
    messager.verifyError(
  ...
  public void underriddenToString() throws CannotGenerateCodeException {
    ...
    assertThat(builder.getDatatype().getStandardMethodUnderrides())
        .isEqualTo(ImmutableMap.of(StandardMethod.TO_STRING, UnderrideLevel.OVERRIDEABLE));
  }
  ...
  public void finalEquals() throws CannotGenerateCodeException {
    ...
    assertThat(builder.getDatatype().getStandardMethodUnderrides())
        .isEqualTo(ImmutableMap.of(StandardMethod.EQUALS, UnderrideLevel.FINAL));
    messager.verifyError(
        "equals", "hashCode and equals must be implemented together on FreeBuilder types");
  }
  ...
  public void finalHashCode() throws CannotGenerateCodeException {
    ...
    assertThat(builder.getDatatype().getStandardMethodUnderrides())
        .isEqualTo(ImmutableMap.of(StandardMethod.HASH_CODE, UnderrideLevel.FINAL));
    messager.verifyError(
        "hashCode", "hashCode and equals must be implemented together on FreeBuilder types");
  }
  ...
  public void finalToString() throws CannotGenerateCodeException {
    ...
    assertThat(builder.getDatatype().getStandardMethodUnderrides())
        .isEqualTo(ImmutableMap.of(StandardMethod.TO_STRING, UnderrideLevel.FINAL));
  }
  ...
  public void genericClassWithTwoProperties() throws CannotGenerateCodeException {
    ...
    QualifiedName dataType = QualifiedName.of("com.example", "DataType");
    QualifiedName generatedType = QualifiedName.of("com.example", "DataType_Builder");
    assertThat(builder.getDatatype())
        .isEqualTo(
            new Datatype.Builder()
  ...
  public void genericTypeWithBounds() throws CannotGenerateCodeException {
    GeneratedBuilder builder =
        (GeneratedBuilder)
            analyser.analyse(
                model.newType(
                    "package com.example;",
                    "public class DataType<A extends CharSequence, B extends "
    ...
    assertEquals("DataType.Builder<A, B>", builder.getDatatype().getBuilder().toString());
    assertEquals(
        "DataType<A extends CharSequence, B extends Temporal>",
  ...
  public void genericType_rebuilt() throws CannotGenerateCodeException {
    ...
    model.newType("package com.example;", "abstract class DataType_Builder<A, B> {}");
    GeneratedBuilder builder =
        (GeneratedBuilder)
            analyser.analyse(
                model.newType(
  ...
  public void wrongBuilderSuperclass_actualType() throws CannotGenerateCodeException {
    model.newType("package com.example;", "class SomeOther_Builder { }");
    analyser.analyse(
        model.newType(
            "package com.example;",
            "public interface DataType {",
  ...
  public void explicitPrivateScopeNoArgsConstructor() {
    try {
      analyser.analyse(
          model.newType(
              "package com.example;", "public class DataType {", "  private DataType() { }", "}"));
      fail("Expected CannotGenerateCodeException");
    } catch (CannotGenerateCodeException expected) {
    }
  ...
  public void freeEnumBuilder() {
    try {
      analyser.analyse(model.newType("package com.example;", "public enum DataType {}"));
      fail("Expected CannotGenerateCodeException");
    } catch (CannotGenerateCodeException expected) {
    }
  ...
  private static Map<String, Property> propertiesByName(GeneratedBuilder builder) {
    return builder.getGeneratorsByProperty().keySet().stream()
