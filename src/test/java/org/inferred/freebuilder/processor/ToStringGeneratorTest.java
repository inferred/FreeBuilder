...
public class ToStringGeneratorTest {
  ...
  public void noProperties() {
    ...
    assertThat(builder.valueToString())
        .isEqualTo(
            "\n"
                + "@Override\n"
                ...
                + "  return \"Person{}\";\n"
                + "}\n");
    assertThat(builder.partialToString())
        .isEqualTo(
            "\n"
                + "@Override\n"
                + "public String toString() {\n"
  ...
  public void threeDefaults() {
    ToStringBuilder builder =
        builderFor("Person").withDefault("name").withDefault("age").withDefault("shoeSize");
  ...
  public void threeRequired() {
    ToStringBuilder builder =
        builderFor("Person").withRequired("name").withRequired("age").withRequired("shoeSize");
  ...
  public void threeOptional() {
    ToStringBuilder builder =
        builderFor("Person").withOptional("name").withOptional("age").withOptional("shoeSize");
  ...
  public void requiredDefaultRequired() {
    ToStringBuilder builder =
        builderFor("Person").withRequired("name").withDefault("age").withRequired("shoeSize");
  ...
  public void defaultDefaultRequired() {
    ToStringBuilder builder =
        builderFor("Person").withDefault("name").withDefault("age").withRequired("shoeSize");
  ...
  public void defaultRequiredDefault() {
    ToStringBuilder builder =
        builderFor("Person").withDefault("name").withRequired("age").withDefault("shoeSize");
  ...
  public void requiredDefaultDefault() {
    ToStringBuilder builder =
        builderFor("Person").withRequired("name").withDefault("age").withDefault("shoeSize");
    ...
    ToStringBuilder(String typename) {
      datatype =
          new Datatype.Builder()
              ...
              .setPropertyEnum(
                  QualifiedName.of("com.example", typename + "_Builder", "Property")
                      .withParameters())
              .buildPartial();
    }
