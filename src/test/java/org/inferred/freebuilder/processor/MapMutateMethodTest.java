...
public class MapMutateMethodTest {
  ...
  private static final JavaFileObject CHECKED_SET_TYPE = new SourceBuilder()
      ...
      .addLine("")
      .addLine("  public static class Builder extends DataType_Builder {")
      .addLine("    @Override void checkProperties(int key, String value) {")
  ...
  private static final JavaFileObject INCORRECTLY_CHECKED_SET_TYPE = new SourceBuilder()
      .addLine("package com.example;")
      .addLine("import static %s.checkArgument;", Preconditions.class)
      .addLine("@%s", FreeBuilder.class)
      .addLine("public interface DataType {")
  ...
  private static final JavaFileObject DOUBLE_CHECKED_SET_TYPE = new SourceBuilder()
      .addLine("package com.example;")
      .addLine("import static %s.checkArgument;", Preconditions.class)
      .addLine("@%s", FreeBuilder.class)
      .addLine("public interface DataType {")
  ...
  public void warningIssuedWhenIncorrectMethodOverridden() {
    behaviorTester
        .with(new Processor())
        .with(INCORRECTLY_CHECKED_SET_TYPE)
        .compiles()
        .withWarning("Overriding put methods on @FreeBuilder types is deprecated; please override "
