...
public class DefaultSourceTest {
  ...
  public void twoPropertiesWithDefaults() {
    ...
    assertThat(generatedType).generates(
        ...
        "    }",
        "",
        "    void configureBuilder(Person_Builder builder) {",
        "      builder.name = name;",
        "      builder.age = age;",
        "    }",
        "",
  ...
  public void twoRequiredProperties() {
    ...
    assertThat(builder).given(GuavaLibrary.AVAILABLE).generates(
        ...
        "    Partial(Person_Builder builder) {",
        "      super(builder);",
        "      _unsetProperties = builder._unsetProperties.clone();",
        "    }",
        "",
        "    @Override",
        "    public String name() {",
        ...
        "          && Objects.equals(_unsetProperties, ((Partial) obj)._unsetProperties);",
        "    }",
        "",
        "    @Override",
        "    public int hashCode() {",
        "      return 31 * super.hashCode() + _unsetProperties.hashCode();",
        "    }",
        "",
        "    @Override",
        "    public String toString() {",
  ...
  public void genericType() {
    ...
    assertThat(builder).given(GuavaLibrary.AVAILABLE).generates(
        ...
        "  }",
        "",
        "  private static class Value<A, B> extends Person<A, B> {",
        ...
        "    }",
        "",
        "    void configureBuilder(Person_Builder<A, B> builder) {",
        "      builder.name = name;",
        "      builder.age = age;",
        "      builder._unsetProperties.clear();",
        "    }",
        ...
        "  }",
        "",
        "  private static class Partial<A, B> extends Value<A, B> {",
        "    private final EnumSet<Property> _unsetProperties;",
        "",
