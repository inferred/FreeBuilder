...
public class NullablePropertyFactoryTest {
    ...
    ExecutableElement getterMethod =
        (ExecutableElement)
            model.newElementWithMarker(
                ...
                "}");
    Property property = new Property.Builder().setType(getterMethod.getReturnType()).buildPartial();
  ...
  public void nullable() {
    ...
    DeclaredType builderType =
        (DeclaredType) getOnlyElement(typesIn(dataType.getEnclosedElements())).asType();
  ...
  public void arbitraryNullableAnnotation() {
    model.newType("package foo.bar;", "public @interface Nullable {}");
    TypeElement dataType =
        model.newType(
            "package com.example;",
            "public class DataType {",
