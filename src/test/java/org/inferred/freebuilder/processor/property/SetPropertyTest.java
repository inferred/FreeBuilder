...
public class SetPropertyTest {
  ...
  public static Iterable<Object[]> parameters() {
    ...
    return () ->
        Lists.cartesianProduct(sets, TYPES_WITH_NON_COMPARABLE, conventions, features).stream()
            .map(List::toArray)
            .iterator();
  }
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                .addLine("DataType value = new DataType.Builder()")
                .addLine(
                    "    .addAllItems(%s.of(%s))", ImmutableList.class, elements.examples(1, 0))
                .addLine("    .build();")
                .addLine(
                    "assertThat(value.%s).containsExactly(%s).inOrder();",
                    convention.get(), elements.examples(set.inOrder(1, 0)))
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                .addLine("new DataType.Builder()")
                .addLine(
                    "    .addAllItems(%s.asList(%s, null));", Arrays.class, elements.example(0))
                .build())
        .runTest();
  }
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                .addLine("DataType value = new DataType.Builder()")
                .addLine(
                    "    .addAllItems(%s.of(%s))", ImmutableList.class, elements.examples(0, 0))
                .addLine("    .build();")
                .addLine(
                    "assertThat(value.%s).containsExactly(%s).inOrder();",
                    convention.get(), elements.example(0))
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                ...
                .addLine(
                    "%s<%s> itemsView = builder.%s;", set.type(), elements.type(), convention.get())
                .addLine("assertThat(itemsView).isEmpty();")
                .addLine("builder.addItems(%s);", elements.examples(1, 0))
                .addLine(
                    "assertThat(itemsView).containsExactly(%s).inOrder();",
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                ...
                .addLine(
                    "    .containsExactly(%s).inOrder();", elements.examples(set.inOrder(1, 0)))
                .build())
        .runTest();
  }
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                ...
                .addLine(
                    "    .containsExactly(%s).inOrder();", elements.examples(set.inOrder(0, 2, 1)))
                .build())
        .runTest();
  }
    ...
    behaviorTester
        ...
        .with(
            SourceBuilder.forTesting()
                ...
                .addLine("public abstract class DataType {")
                .addLine(
                    "  public abstract %s<%s> %s;", set.type(), elements.type(), convention.get())
                .addLine("")
                .addLine("  public static class Builder extends DataType_Builder {")
  ...
  public void testPrimitiveValidation_addAllIntStream() {
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                .addLine("new DataType.Builder().addAllItems(%s.of(3, -4));", IntStream.class)
                .build())
        .runTest();
  }
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                ...
                .addLine(
                    "  @Override public %s<%s> %s {", set.type(), elements.type(), convention.get())
                .addLine(
                    "    return %s.of(%s, %s);",
  ...
  private static TestBuilder testBuilder() {
    return new TestBuilder().addImport("com.example.DataType").addImport(Stream.class);
  }
}
