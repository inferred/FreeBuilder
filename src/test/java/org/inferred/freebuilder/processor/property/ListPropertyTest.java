...
import static org.inferred.freebuilder.processor.property.ElementFactory.INTEGERS;
...
public class ListPropertyTest {
  ...
  public ListPropertyTest(
      ElementFactory elements, NamingConvention convention, FeatureSet features) {
    ...
    validatedType =
        SourceBuilder.forTesting()
            ...
            .addLine("  public static class Builder extends DataType_Builder {")
            .addLine(
                "    @Override public Builder addItems(%s element) {", elements.unwrappedType())
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                .addLine("new DataType.Builder()")
                .addLine(
                    "    .addAllItems(Stream.of(%s, (%s) null).spliterator());",
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                .addLine("new DataType.Builder()")
                .addLine(
                    "    .addAllItems(Stream.of(%s, (%s) null));",
                    elements.example(0), elements.type())
                .build())
        .runTest();
  }
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                .addLine("DataType value = new DataType.Builder()")
                .addLine(
                    "    .addAllItems(%s.of(%s))", ImmutableList.class, elements.examples(0, 1))
                .addLine("    .build();")
                .addLine(
                    "assertThat(value.%s).containsExactly(%s).inOrder();",
                    convention.get(), elements.examples(0, 1))
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                ...
                .addLine(
                    "%s<%s> itemsView = builder.%s;", List.class, elements.type(), convention.get())
                .addLine("assertThat(itemsView).isEmpty();")
                .addLine("builder.addItems(%s);", elements.examples(0, 1))
                .addLine(
                    "assertThat(itemsView).containsExactly(%s).inOrder();", elements.examples(0, 1))
                .addLine("builder.clearItems();")
                .addLine("assertThat(itemsView).isEmpty();")
                .addLine("builder.addItems(%s);", elements.examples(2, 3))
                .addLine(
                    "assertThat(itemsView).containsExactly(%s).inOrder();", elements.examples(2, 3))
                .build())
        .runTest();
  }
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                ...
                .addLine(
                    "assertThat(builder.%s).containsExactly(%s).inOrder();",
                    convention.get(), elements.examples(0, 1))
                .build())
        .runTest();
  }
    ...
    behaviorTester
        ...
        .with(
            SourceBuilder.forTesting()
                ...
                .addLine("public abstract class DataType {")
                .addLine(
                    "  public abstract %s<%s> %s;", List.class, elements.type(), convention.get())
                .addLine("")
                .addLine("  public static class Builder extends DataType_Builder {")
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                ...
                .addLine("    .build();")
                .addLine(
                    "assertThat(value.%s).containsExactly(%s, %s).inOrder();",
  ...
  public void testListOfParameterWildcards() {
    behaviorTester
        ...
        .with(
            testBuilder()
                .addLine(
                    "DataType<%1$s> value = new DataType.Builder<%1$s>()", elements.supertype())
                .addLine("    .addItems(%s)", elements.example(0))
                .addLine("    .addItems(%s)", elements.supertypeExample())
                .addLine("    .build();")
                .addLine(
  ...
  public void testValidation_varargsAdd() {
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                .addLine(
                    "new DataType.Builder().addItems(%s, %s);",
  ...
  public void testValidation_addAllSpliterator() {
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                .addLine(
                    "new DataType.Builder().addAllItems(Stream.of(%s, %s).spliterator());",
                    elements.example(0), elements.invalidExample())
                .build())
        .runTest();
  }
  ...
  public void testValidation_addAllStream() {
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                .addLine(
                    "new DataType.Builder().addAllItems(Stream.of(%s, %s));",
                    elements.example(0), elements.invalidExample())
                .build())
        .runTest();
  }
  ...
  public void testValidation_addAllIterable() {
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                .addLine(
                    "new DataType.Builder().addAllItems(%s.of(%s, %s));",
    ...
    behaviorTester
        ...
        .with(
            testBuilder()
                ...
                .addLine(
                    "assertThat(clone.%s).containsExactly(%s).inOrder();",
                    convention.get(), elements.examples(0, 1))
                .build())
        .runTest();
  }
  ...
  public void testCompilesWithoutWarnings() {
    behaviorTester.with(new Processor(features)).with(listPropertyType).compiles().withNoWarnings();
  }
    ...
    behaviorTester
        ...
        .with(
            SourceBuilder.forTesting()
                ...
                .addLine("public abstract class DataType {")
                .addLine(
                    "  public abstract %1$s<%1$s<%2$s>> %3$s;",
                    List.class, elements.type(), convention.get())
                .addLine("")
                .addLine("  public static class Builder extends DataType_Builder {}")
                .addLine("}"))
  ...
  public void testGenericBuildableTypeCompilesWithoutHeapPollutionWarnings() {
    behaviorTester
        ...
        .with(
            testBuilder()
                .addLine(
                    "new DataType.Builder<%s>().addItems(%s).build();",
