...
public class DefaultSourceTest {
  ...
  public void testRequiredProperties_j6() {
    ...
    assertThat(generateSource(metadata, GuavaLibrary.AVAILABLE)).isEqualTo(Joiner.on('\n').join(
        ...
        "    Person.Builder.checkName(Preconditions.checkNotNull(name));",
        "    this.name = name;",
        ...
        "",
        "  /**",
        "   * Checks that {@code name} may be returned by {@link Person#getName()}.",
        "   * Redefine this method in {@link Person.Builder} to perform argument validation,",
        "   * throwing an IllegalArgumentException if validation fails.",
        "   */",
        ...
        "",
        "  /**",
        "   * Checks that {@code age} may be returned by {@link Person#getAge()}.",
        "   * Redefine this method in {@link Person.Builder} to perform argument validation,",
        "   * throwing an IllegalArgumentException if validation fails.",
        "   */",
  ...
  public void testGenericType_j6() {
    ...
    assertThat(generateSource(metadata, GuavaLibrary.AVAILABLE)).isEqualTo(Joiner.on('\n').join(
        ...
        "   * throwing an IllegalArgumentException if validation fails.",
        "   */",
        "  static <A> void checkName(A name) {}",
        "",
        "  /**",
        "   * Sets the value to be returned by {@link Person#getAge()}.",
        "   *",
        ...
        "    Person.Builder.checkAge(Preconditions.checkNotNull(age));",
        "    this.age = age;",
        "    _unsetProperties.remove(Person_Builder.Property.AGE);",
        "    return (Person.Builder<A, B>) this;",
        "  }",
  ...
  public void testRequiredProperties_noGuava_j7() {
    ...
    assertThat(generateSource(metadata, JAVA_7)).isEqualTo(Joiner.on('\n').join(
        ...
        "   */",
        "  public Person.Builder setName(String name) {",
        "    Person.Builder.checkName(Objects.requireNonNull(name));",
        "    this.name = name;",
        "    _unsetProperties.remove(Person_Builder.Property.NAME);",
        "    return (Person.Builder) this;",
        "  }",
   ...
   */
  @Test
  public void testOneRequiredProperty_noGuava_j6() {
    ...
    Metadata metadata = new Metadata.Builder()
        ...
        .addProperties(name
            .setCodeGenerator(
                new DefaultPropertyFactory.CodeGenerator(name.build(), false, false))
            .build())
        .addProperties(age
            .setCodeGenerator(
                new DefaultPropertyFactory.CodeGenerator(age.build(), true, false))
            .build())
        .addProperties(shoeSize
            .setCodeGenerator(
                new DefaultPropertyFactory.CodeGenerator(shoeSize.build(), false, false))
            .build())
    ...
    assertThat(generateSource(metadata)).isEqualTo(Joiner.on('\n').join(
        ...
        "    Person.Builder.checkShoeSize(shoeSize);",
        ...
        "",
        "  /**",
        "   * Checks that {@code shoeSize} may be returned by {@link Person#getShoeSize()}.",
        "   * Redefine this method in {@link Person.Builder} to perform argument validation,",
        "   * throwing an IllegalArgumentException if validation fails.",
        "   */",
        "  static void checkShoeSize(int shoeSize) {}",
        "",
        "  /**",
        "   * Sets all property values using the given {@code Person} as a template.",
        "   */",
  ...
  private static Metadata createMetadataWithRequiredProperties() {
    ...
    Metadata metadata = new Metadata.Builder()
        ...
        .addProperties(age
            .setCodeGenerator(
                new DefaultPropertyFactory.CodeGenerator(age.build(), false, false))
            .build())
        .setPropertyEnum(generatedBuilder.nestedType("Property").withParameters())
        .setType(person.withParameters())
        .setValueType(generatedBuilder.nestedType("Value").withParameters())
  ...
  private static Metadata createMetadataWithDefaults() {
    ...
    Metadata metadata = new Metadata.Builder()
        ...
        .addProperties(name
            .setCodeGenerator(
                new DefaultPropertyFactory.CodeGenerator(name.build(), true, false))
            .build())
        .addProperties(age
            .setCodeGenerator(
                new DefaultPropertyFactory.CodeGenerator(age.build(), true, false))
