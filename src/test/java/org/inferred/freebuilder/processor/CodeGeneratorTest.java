...
public class CodeGeneratorTest {
  ...
  public void testSimpleDataType() {
    ...
    assertThat(sourceBuilder.toString()).isEqualTo(Joiner.on('\n').join(
        ...
        "  private static final Joiner COMMA_JOINER =", // TODO remove newline
        "      Joiner.on(\", \").skipNulls();",
        "",
        "",
        ...
        "      throw new IllegalStateException(\"age not set\");", // TODO checkState
        "    }",
        "    return age;",
        "  }",
        "",
        ...
        "    @Override",
        "    public int hashCode() {",
               // TODO Just call Arrays.hashCode
        "      // Return the same result as passing all the fields",
        "      // into Arrays.hashCode() in an Object[].",
        "      int result = 1;",
        "      result *= 31;",
        ...
        "",
        "  /**",
        "   * Returns a newly-created {@link Person}", // TODO remove newline
        ...
        "   */",
        "  public Person build() {",
        "    if (!_unsetProperties.isEmpty()) {", // TODO use checkState
        ...
        "",
        "  /**",
        "   * Sets all property values using the given", // TODO remove newline
        "   * {@code Person} as a template.",
        "   */",
