...
public class ListSourceTest {
  ...
  public void test_guava_j6() {
    ...
    assertThat(generateSource(metadata, GuavaLibrary.AVAILABLE)).isEqualTo(Joiner.on('\n').join(
        ...
        "   */",
        "  public final Person.Builder addName(String element) {",
        "    checkName(Preconditions.checkNotNull(element));",
        ...
        "",
        "  /**",
        "   * Checks that {@code element} can be put into the list to be returned from",
        "   * {@link Person#getName()}.",
        "   *",
        "   * <p>Override this to perform argument validation, throwing an",
        "   * IllegalArgumentException if validation fails.",
        "   */",
        "  @SuppressWarnings(\"unused\") // element may be used in an overriding method",
        "  void checkName(String element) {}",
        "",
        "  /**",
        ...
        "   * @return this {@code Builder} object",
        "   */",
        "  public final Person.Builder addAge(int element) {",
        "    checkAge(element);",
  ...
  public void test_noGuava_j7() {
    ...
    assertThat(generateSource(metadata, JAVA_7)).isEqualTo(Joiner.on('\n').join(
        ...
        "   */",
        "  public final Person.Builder addName(String element) {",
        "    checkName(Objects.requireNonNull(element));",
        "    this.name.add(element);",
        "    return (Person.Builder) this;",
        "  }",
        "",
  ...
  @Test
  public void test_overridingCheckMethodAddsIllegalArgumentExceptionToJavaDoc() {
    ...
    Property.Builder age = new Property.Builder()
        ...
        .setName("age")
        .setType(listInteger);
    Metadata metadata1 = new Metadata.Builder()
        ...
        .addProperties(name
            .setCodeGenerator(new ListPropertyFactory.CodeGenerator(
                name.build(), true, false, string, Optional.<TypeMirror>absent()))
            .build())
        .addProperties(age
            .setCodeGenerator(new ListPropertyFactory.CodeGenerator(
                age.build(), true, false, integer, Optional.<TypeMirror>of(INT)))
            .build())
    ...
    assertThat(generateSource(metadata, GuavaLibrary.AVAILABLE)).isEqualTo(Joiner.on('\n').join(
        ...
        "   * @return this {@code Builder} object",
        "   * @throws NullPointerException if {@code element} is null",
        "   * @throws IllegalArgumentException if {@code element} is invalid",
        "   */",
        "  public final Person.Builder addName(String element) {",
        "    checkName(Preconditions.checkNotNull(element));",
        "    this.name.add(element);",
        ...
        "   * @throws NullPointerException if {@code elements} is null or contains a",
        "   *     null element",
        "   * @throws IllegalArgumentException if {@code elements} contains an invalid element",
        "   */",
        "  public Person.Builder addName(String... elements) {",
        "    name.ensureCapacity(name.size() + elements.length);",
        "    for (String element : elements) {",
  ...
  private static Metadata createMetadata() {
    ...
    Metadata metadata = new Metadata.Builder()
        ...
        .addProperties(name
            .setCodeGenerator(new ListPropertyFactory.CodeGenerator(
                name.build(), false, false, string, Optional.<TypeMirror>absent()))
            .build())
        .addProperties(age
            .setCodeGenerator(new ListPropertyFactory.CodeGenerator(
                age.build(), false, false, integer, Optional.<TypeMirror>of(INT)))
            .build())
        .setPropertyEnum(generatedBuilder.nestedType("Property").withParameters())
        .setType(person.withParameters())
        .setValueType(generatedBuilder.nestedType("Value").withParameters())
