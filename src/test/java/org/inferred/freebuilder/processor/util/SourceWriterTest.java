...
public class SourceWriterTest {
  ...
  public void testConstructor() throws FilerException {
    try (SourceWriter sourceWriter = newSourceWriter("com.example.Bar")) {
      // Do nothing
    }
    assertEquals(
  ...
  public void testAddLine_typeInDifferentPackage() throws FilerException {
    try (SourceWriter sourceWriter = newSourceWriter("com.example.Bar")) {
      sourceWriter.addLine("// This should be long: %s", AtomicLong.class);
    }
    assertThat(source.toString())
        .contains("// This should be long: java.util.concurrent.atomic.AtomicLong\n");
  }

  @Test
  public void testAddLine_nestedTypeInDifferentPackage() throws FilerException {
    try (SourceWriter sourceWriter = newSourceWriter("com.example.Bar")) {
      sourceWriter.addLine("// This should be long: %s", ImmutableList.Builder.class);
    }
    assertThat(source.toString())
        .contains("// This should be long: com.google.common.collect.ImmutableList.Builder\n");
  }
  ...
  public void testAddLine_typeMirrorInDifferentPackage() throws FilerException {
    try (SourceWriter sourceWriter = newSourceWriter("com.example.Bar")) {
      sourceWriter.addLine("// This should be long: %s", model.typeMirror(AtomicLong.class));
    }
    assertThat(source.toString())
        .contains("// This should be long: java.util.concurrent.atomic.AtomicLong\n");
  }
  ...
  public void testAddLine_genericTypeMirror() throws FilerException {
    try (SourceWriter sourceWriter = newSourceWriter("com.example.Bar")) {
      sourceWriter.addLine("// This should be long: %s",
          model.typeMirror("java.util.List<java.lang.String>"));
    }
    assertThat(source.toString())
        .contains("// This should be long: java.util.List<java.lang.String>\n");
  }
  ...
  public void testAddLine_genericTypeElement() throws FilerException {
    ...
    assertThat(source.toString()).contains("// This should be long: java.util.List\n");
  }
  ...
  private SourceWriter newSourceWriter(String typename) throws FilerException {
    ...
    ImpliedClass classToWrite = new ImpliedClass(
        ...
        originatingElement,
        model.elementUtils());
    return new SourceWriter(filer, classToWrite, originatingElement);
  }
}
