...
public class CompilationUnitBuilderTest {
  ...
  public void testAddLine_typeRepeated() {
    String code = newSourceWriter("com.example", "Bar")
  ...
  public void testAddLine_typesWithSameName() {
    CompilationUnitBuilder source = newSourceWriter("com.example", "Bar");
    source.addLine("// This should be explicit: %s", java.util.List.class);
    source.addLine("// This should be explicit: %s", java.awt.List.class);
    assertThat(source.toString()).doesNotContain("import java.util.List;\n");
    assertThat(source.toString()).doesNotContain("import java.awt.List;\n");
    assertThat(source.toString()).contains("// This should be explicit: java.util.List\n");
