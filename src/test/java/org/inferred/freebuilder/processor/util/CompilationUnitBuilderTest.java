...
public class CompilationUnitBuilderTest {
  ...
  public void testEmptyUnit() {
    String code = newSourceWriter("com.example", "Bar").toString();
    assertEquals(
  ...
  public void testAddLine_typeInSamePackage() {
    String code = newSourceWriter("com.example", "Bar")
        .addLine("// This should be short: %s", originatingElement)
        .toString();
  ...
  public void testAddLine_errorTypeArgument() {
    ...
    newSourceWriter("com.example", "Bar").addLine("%s", errorType);
  }
