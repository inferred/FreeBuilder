...
public class PreconditionExcerpts {
  ...
  /**
   * Returns an excerpt equivalent to Guava's {@link Preconditions#checkArgument(boolean, String,
   * Object...)}.
   *
   * <ul>
  ...
  public static Excerpt checkArgument(
      String conditionTemplate, String messageTemplate, Object... args) {
    return new GuavaCheckExcerpt(
        "checkArgument", conditionTemplate, messageTemplate, args, IllegalArgumentException.class);
  }

  /**
   * Returns an excerpt equivalent to Guava's {@link Preconditions#checkState(boolean, String,
   * Object...)}.
   *
   * <ul>
  ...
  private static final class GuavaCheckExcerpt implements Excerpt {
    ...
    private void addIfBlockTo(SourceBuilder code) {
      ...
      code.addLine(") {").add("  throw new %s(", exceptionType);
